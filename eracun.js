  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    try {
      var stmt = pb.prepare("\
        ...
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?)", [polja.FirstName, polja.LastName, polja.Company, polja.Address, polja.City, polja.State, polja.Country, polja.PostalCode, polja.Phone, polja.Fax, polja.Email, 3]);
      ...
      stmt.finalize();
      odgovor.redirect('/prijava1');
    } catch (err) {
      napaka2 = true;
      odgovor.redirect('/prijava2');
    }
    odgovor.end();
  });
})
...
// Prikaz strani za prijavo po registraciji
streznik.get('/prijava1', function(zahteva, odgovor) {
  vrniStranke(function(napaka1, stranke) {
      vrniRacune(function(napaka2, racuni) {
...
// Prikaz strani za prijavo po registraciji
streznik.get('/prijava2', function(zahteva, odgovor) {
  vrniStranke(function(napaka1, stranke) {
      vrniRacune(function(napaka2, racuni) {
